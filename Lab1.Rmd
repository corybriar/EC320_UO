...
We'll use `ggplot2` a lot throughout the quarter, so try to get comfortable with it. There's a great [*cheatsheet*]() resource for discovering more functionality with the package; I use it all the time for GIS mapping for instance.
